  ...
  return (
    <div className="auth-bg flex items-center justify-center px-4 py-6 sm:py-12">
      <div className="w-full max-w-[420px]">
            ...
            <div>
              ...
              <div className="form-input-group">
                ...
                <input
                  ...
                  placeholder="john@transcom.com or EMP-1234"
        ...
        <p className="text-center text-xs text-slate-400 mt-4 animate-fade-in-up animate-delay-300">
          By signing in, you agree to Transcom&apos;s{" "}
          <a href="#" className="underline hover:text-slate-500">Terms of Service</a>
          {" "}and{" "}
          <a href="#" className="underline hover:text-slate-500">Privacy Policy</a>
        </p>
      </div>
    </div>
  );
